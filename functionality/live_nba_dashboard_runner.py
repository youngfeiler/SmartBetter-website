...
class live_nba_dashboard_runner():
    def __init__(self):
        self.model_storage = {}
    ...
    def store_model_info(self):
          loaded_model = torch.load(f'models/model_objs/nba_model_1.pth')
          with open(f'models/encoders/nba_model_1.pkl', 'rb') as f:
            loaded_encoder = pickle.load(f)
          with open(f'models/scalers/nba_model_1.pkl', 'rb') as f:
            loaded_scaler = pickle.load(f)
          with open(f'models/params/nba_model_1.pkl', 'rb') as f:
