...
if __name__ == "__main__":
    ...
    while True:
      try:
        new_nba_df = pd.read_csv("pos_ev_data/nba_pos_ev_data.csv")
        new_nhl_df = pd.read_csv("pos_ev_data/nhl_pos_ev_data.csv")
        new_nncaab_df = pd.read_csv("pos_ev_data/ncaab_pos_ev_data.csv")
        ...
        if not are_dataframes_equal(combined_df, new_combined_df):
            ...
            # Check
            combined_df.to_csv("pos_ev_data/pos_ev_dash_data.csv")
